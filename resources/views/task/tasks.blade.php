...
@section('content')
    ...
    <ul class="task-list">
        <li>
            <div class="left-border task-example">
                <a class="pending-task">не перевірено</a>
                <a class="completed-task" >перевірено</a>
                <a class="theory">теорія</a>
                <a class="teacher-none">не здано</a>
            </div>
        </li>
    </ul>
    @if(isset($myCourse))
