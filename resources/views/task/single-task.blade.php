        ...
        @if($task->type == "practice")
            <div>
                <div class="task-answer">
                    ...
                    @endif
                    <div
                        class="task-info @if(Auth::user()->id == $teacher->id) teacher-task-info @endif ">
                        @if(Auth::user()->id != $teacher->id )
                            <div class="task-info-status">
                                ...
                                <div>
                                    <p class=" @if(isset($completedTask)) @if($completedTask->status == "Оцінено") rated @elseif($completedTask->status == "Не оцінено") pending  @endif @endif">@if($completedTask)
                        ...
                        <div class="task-button-edit">
                            ...
                            @elseif(empty($completedTask)&& Auth::user()->id != $teacher->id)
